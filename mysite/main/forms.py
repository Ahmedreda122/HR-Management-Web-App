...
class VacationForm(forms.ModelForm):
    ...
    startDate = forms.DateField(
        label="Start Date",
        widget=DateInput(attrs={"type": "date", "class": "Date", "id": "startD"}),
    )
...
class LoginForm(forms.Form):
    type = forms.ChoiceField(
        label="",
        choices=[("HR Specialist", "HR Specialist"), ("Manager", "Manager")],
        initial="HR Specialist",
        widget=forms.Select(attrs={"class": "SelectField"}),
    )
